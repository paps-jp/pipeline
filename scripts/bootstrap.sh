...
#   curl -sSL http://control-plane.example:8001/bootstrap.sh | sudo bash
#
# 環境変数:
#   CTRL_URL                control plane URL (default: http://control-plane.example:8001)
...
log "確認: http://control-plane.example:8001/logs で「$HN」 タブを開いて daemon log を確認"
